...
import vn.hbtplus.tax.personal.models.request.ObjectAttributesRequest;
...
/**
 * Lop repository Impl ung voi bang abs_object_attributes
 * @author tudd
 * @since 1.0
 * @version 1.0
 */
...
public class ObjectAttributesRepository extends BaseRepository {
    ...
    public void deleteAttributes(Long objectId, String tableName, List<String> codes) {
        String sql = """
                delete a from abs_object_attributes a 
