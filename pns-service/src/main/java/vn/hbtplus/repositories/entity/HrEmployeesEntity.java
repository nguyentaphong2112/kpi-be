...
public class HrEmployeesEntity extends BaseEntity {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof HrEmployeesEntity entity) {
            return entity.getEmployeeId().equals(this.employeeId) && entity.getEmployeeCode().equals(this.employeeCode);
        }
