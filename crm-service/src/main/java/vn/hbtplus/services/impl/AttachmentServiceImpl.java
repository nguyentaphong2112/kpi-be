...
public class AttachmentServiceImpl implements AttachmentService {
    ...
    public Attachment getAttachmentEntity(String tableName, String fileType, Long objectId) {
        List<Attachment> attachments = attachmentRepository.getAttachments(tableName, fileType, List.of(objectId), Attachment.class);
    ...
    public List<Attachment> getAttachmentEntities(String tableName, String fileType, Long objectId) {
        return attachmentRepository.getAttachments(tableName, fileType, List.of(objectId), Attachment.class);
    }
    ...
    public List<AttachmentFileDto> getAttachmentList(String tableName, String fileType, List<Long> objIds) {
        return attachmentRepository.getAttachments(tableName, fileType, objIds, AttachmentFileDto.class);
    }

    @Override
    @Transactional(readOnly = true)
    public List<Attachment> getAttachmentListByObjectId(String tableName, String fileType, Long objId) {
        List<AttachmentDto> attachments = attachmentRepository.getAttachments(tableName, fileType, List.of(objId), AttachmentDto.class);
        return Utils.mapAll(attachments, Attachment.class);
    }
}
