...
@Data
@Entity
@Table(name = "kpi_object_relations")
public class ObjectRelationsEntity extends BaseEntity {
    ...
    public interface TABLE_NAMES {
        String INDICATORS = "kpi_indicators";
        String ORGANIZATIONS = "hr_organizations";
    }
    public interface FUNCTION_CODES {
        String PHAM_VI_AP_DUNG = "PHAM_VI_AP_DUNG";
        String CHI_SO_LIEN_QUAN = "CHI_SO_LIEN_QUAN";
    }
}
