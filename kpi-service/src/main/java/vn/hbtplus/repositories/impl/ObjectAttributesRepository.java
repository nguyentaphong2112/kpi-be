...
/**
 * Lop repository Impl ung voi bang kpi_object_attributes
 * @author tudd
 * @since 1.0
 * @version 1.0
 */
...
public class ObjectAttributesRepository extends BaseRepository {
    ...
    public void deleteAttributes(Long objectId, String tableName, List<String> codes) {
        String sql = """
                delete a from kpi_object_attributes a 
    ...
    public String getAttribute(Long id, String attributeCode, String tableName) {
        String sql = """
                select a.attribute_value from kpi_object_attributes a 
                where a.object_id = :id
                and a.table_name = :tableName
                and a.attribute_code in (:attributeCode)
                and a.is_deleted = 'N'             
                """;
        Map<String, Object> map = new HashMap<>();
        map.put("id", id);
