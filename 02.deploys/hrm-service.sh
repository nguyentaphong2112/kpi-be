...
export APP_HOME=C:/HRM/app/backend/hrm
export APP_NAME=hrm-service-1.0-SNAPSHOT
export HCM_HRM_PORT=8869
export PID_PATH_NAME=C:/HRM/app/backend/hrm/api.pid
export APP_LOG_PATH=C:/HRM/logs/hrm
...
export HCM_HRM_JDBC_URL=xeaV2D7fRoMA/wnSYJd4kfSQm5SwPCzGv1gJCyYgVXTDpYwpCCOu9Z7m1C1Psmsg
export HCM_HRM_JDBC_USER_NAME=VmmKPYQ0UmnXh0oTQByb0A==
export HCM_HRM_JDBC_PASSWORD=4t4ncQZGNaBRzU6F+3rHlEzE308nTSm0
