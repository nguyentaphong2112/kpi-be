...
export APP_HOME=C:/HRM/app/backend/storage
export APP_LOG_PATH=C:/HRM/logs/storage
export APP_NAME=file-storage-service-1.0-SNAPSHOT
export HCM_STORAGE_PORT=8861
export HCM_STORAGE_PATH=storage-service
export PID_PATH_NAME=C:/HRM/app/backend/storage/api.pid
# cấu hình đường dẫn thư mục export
export HCM_EXPORT_FOLDER=C:/HRM/app/file-exports/
export HCM_UPLOAD_FOLDER=C:/HRM/data/files/uploads/
export HCM_DELETED_FOLDER=C:/HRM/data/files/deleted-files/

# set các biến môi trường cho ứng dụng
# thông tin kết nối được mã hóa jasypt
export HCM_STORAGE_JDBC_URL=Uii+/fD5EICRTLJ0TW7GLIkCjbl5rc+og/+BpHNhaYKf4NYvZX5ZuTLtf1t9lg6p
export HCM_STORAGE_JDBC_USER_NAME=G0XejsdD5Gpmo1gSRfWT8Q==
export HCM_STORAGE_JDBC_PASSWORD=fJd/JnuWAbVSiG3DOXM31eDJLLdbx1KK
...
echo "    APP_PORT=$HCM_STORAGE_PORT"
