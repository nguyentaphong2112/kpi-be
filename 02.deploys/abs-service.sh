...
export APP_HOME=C:/HRM/app/backend/abs
export APP_NAME=abs-service-1.0-SNAPSHOT
export HCM_HRM_PORT=8880
export PID_PATH_NAME=C:/HRM/app/backend/abs/api.pid
export APP_LOG_PATH=C:/HRM/logs/abs
...
export HCM_HRM_JDBC_URL=q+pqcMuW3VTg0C/3Ri2yslAwUO89kUrUu+T/pmYBEgbI+dkfZPjVbK7brfs7AXwI
