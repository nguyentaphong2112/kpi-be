...
import vn.hbtplus.insurance.models.bean.CategoryAttributeBean;
import vn.hbtplus.insurance.models.bean.CategoryBean;
...
public class CategoryRepository extends BaseRepository {
    ...
    public List<CategoryResponse> getCategories(String categoryType) {
        String sql = "select category_id, value, name, code, order_number, description from sys_categories " +
                " where is_deleted = 'N'" +
    ...
    public List<CategoryBean> getListCategoryBeans(String categoryType) {
        ...
        sql = """
                select category_id, attribute_code, value
                 from sys_category_attributes attr
                   where attr.is_deleted = 'N'
                   and attr.category_id in (
