...
public class WorkProcessController {
    ...
    @GetMapping(value = "/v1/work-process/emp/{empId}", produces = MediaType.APPLICATION_JSON_VALUE)
    @HasPermission(scope = Scope.VIEW)
    public ListResponseEntity<WorkProcessResponse> getDataByEmpId(@PathVariable Long empId) {
        return workProcessService.getDataByEmpId(empId);
    }
