...
public class InsuranceSalaryProcessController {
    ...
    @GetMapping(value = "/v1/insurance-salary-process/emp/{empId}", produces = MediaType.APPLICATION_JSON_VALUE)
    @HasPermission(scope = Scope.VIEW)
    public ListResponseEntity<InsuranceSalaryProcessResponse> getDataByEmpId(@PathVariable Long empId) {
        return insuranceSalaryProcessService.getDataByEmpId(empId);
    }
