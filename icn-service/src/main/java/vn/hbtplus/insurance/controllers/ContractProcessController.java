...
public class ContractProcessController {
    ...
    @GetMapping(value = "/v1/emp-type-process/emp/{empId}", produces = MediaType.APPLICATION_JSON_VALUE)
    @HasPermission(scope = Scope.VIEW)
    public ListResponseEntity<ContractProcessResponse> getDataByEmpId(@PathVariable Long empId) {
        return contractProcessService.getDataByEmpId(empId);
    }
