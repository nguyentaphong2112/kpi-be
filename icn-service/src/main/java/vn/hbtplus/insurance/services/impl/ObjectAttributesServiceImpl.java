...
import vn.hbtplus.insurance.models.response.ObjectAttributesResponse;
import vn.hbtplus.insurance.repositories.entity.ObjectAttributesEntity;
import vn.hbtplus.insurance.repositories.impl.ObjectAttributesRepository;
import vn.hbtplus.insurance.repositories.impl.CommonRepository;
import vn.hbtplus.insurance.repositories.jpa.ObjectAttributesRepositoryJPA;
import vn.hbtplus.insurance.services.ObjectAttributesService;
...
public class ObjectAttributesServiceImpl implements ObjectAttributesService {
    ...
    public void saveObjectAttributes(Long objectId, List<AttributeRequestDto> listAttributes, Class className, String functionCode) {
        ...
        List<AttributeConfigDto> configAttributes = objectAttributesRepository.getAttributes(tableName, functionCode);
